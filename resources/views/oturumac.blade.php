...
<!-- Mirrored from html.phoenixcoded.net/nextro-able/bootstrap/default/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Aug 2020 16:42:04 GMT -->
<head>

	<title>TLT WATER CRM</title>
	...
	<div class="auth-content">
		<div class="card">
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					<div class="card-body">
                        <form method="POST" action="{{route('oturumac')}}">
                            {{csrf_field()}}
						<img src="/images/tltlogo.png" alt="" class="img-fluid mb-4">
                        <h4 class="mb-3 f-w-400">TLT WATER CRM</h4>
                        @include('layouts.partials.error')
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text"><i data-feather="mail"></i></span>
							</div>
							<input type="email" name="email" id="email" class="form-control" placeholder="Email adresi">
						</div>
						...
						<div class="form-group text-left mt-2">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input input-primary" name="benihatirla" id="customCheckdefh2" checked="">
								<label class="custom-control-label" for="customCheckdefh2">Beni Hatırla</label>
							</div>
						</div>
						<button class="btn btn-block btn-primary mb-4">Giriş Yap</button>
						<p class="mb-2 text-muted">Şifrem neydi? <a href="auth-reset-password.html" class="f-w-400">Şifre Sıfırla</a></p>
                        <p class="mb-0 text-muted">Hesabınız mı yok? <a href="auth-signup.html" class="f-w-400">Üye Ol</a></p>
                        </form>
					</div>
				</div>
			</div>
